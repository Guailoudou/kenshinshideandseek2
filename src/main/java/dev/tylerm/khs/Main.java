...
public class Main extends JavaPlugin implements Listener {
    ...
    public static RandomEvents randomEvents = new RandomEvents();
    ...
    private void onTick() {
        try {
            ...
            game.onTick();
            disguiser.check();
            randomEvents.tick(getServer(), board.getSeekers(), board.getHiders());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void registerListeners() {
        ...
        getServer().getPluginManager().registerEvents(new InteractHandler(board), this);
