...
public class Board {
    ...
    public void addLeavePlayer(Player player) {
        LeavePlayers.put(player.getUniqueId(),Players.get(player.getUniqueId()));

    }
    public Map<UUID, Board.Type> getLeavePlayers() {
        return LeavePlayers;
    }
    public boolean isLeaveHider(Player player) {
        return LeavePlayers.get(player.getUniqueId()) == Type.HIDER;
    }

    public boolean isLeaveSeeker(Player player) {
        return LeavePlayers.get(player.getUniqueId()) == Type.SEEKER;
    }

    public void addLeaveInventory(Player player) {
        LeaveInventory.put(player.getUniqueId(),  player.getInventory().getContents());
    }
